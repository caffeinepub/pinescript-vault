...
import type { ExternalBlob as _ExternalBlob, InviteStatus as _InviteStatus, InviteStatusType as _InviteStatusType, Product as _Product, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async bootstrap(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bootstrap(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createBundle(arg0: Bundle): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createBundle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createInviteStatus(arg0: string, arg1: InviteStatusType, arg2: string, arg3: string, arg4: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createInviteStatus(arg0, to_candid_InviteStatusType_n10(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBundles(): Promise<Array<Bundle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBundles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCartTotal(arg0: Array<CartItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getCartTotalWithShipping(arg0: Array<CartItem>, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCartTotalWithShipping(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInviteStatuses(): Promise<Array<InviteStatus>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInviteStatuses();
    ...
    async getMyInviteStatuses(): Promise<Array<InviteStatus>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyInviteStatuses();
                return from_candid_vec_n26(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProductPriceAmount(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductPriceAmount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBundle(arg0: Bundle): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBundle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateInviteStatus(arg0: string, arg1: InviteStatusType, arg2: string, arg3: string, arg4: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateInviteStatus(arg0, to_candid_InviteStatusType_n10(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: Product): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(await to_candid_Product_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_InviteStatusType_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _InviteStatusType): InviteStatusType {
    return from_candid_variant_n30(_uploadFile, _downloadFile, value);
}
function from_candid_InviteStatus_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _InviteStatus): InviteStatus {
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    category: string;
    disclaimer: string;
    downloadableFile: [] | [_ExternalBlob];
    longDescription: string;
}): Promise<{
    id: string;
    requiresInvite: boolean;
    ...
    return {
        id: value.id,
        requiresInvite: value.requiresInvite,
        title: value.title,
        ...
        hasScreenshots: value.hasScreenshots,
        currency: value.currency,
        category: value.category,
        disclaimer: value.disclaimer,
        downloadableFile: record_opt_to_undefined(await from_candid_opt_n18(_uploadFile, _downloadFile, value.downloadableFile)),
...
function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        tradingViewUsername: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.tradingViewUsername))
    };
}
function from_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        status: from_candid_InviteStatusType_n29(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "expired" in value ? InviteStatusType.expired : "pending" in value ? InviteStatusType.pending : "granted" in value ? InviteStatusType.granted : "usernameIncorrect" in value ? InviteStatusType.usernameIncorrect : value;
}
...
function from_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_InviteStatus>): Array<InviteStatus> {
    return value.map((x)=>from_candid_InviteStatus_n27(_uploadFile, _downloadFile, x));
}
...
function to_candid_InviteStatusType_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InviteStatusType): _InviteStatusType {
...
async function to_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: value.category,
        disclaimer: value.disclaimer,
        downloadableFile: value.downloadableFile ? candid_some(await to_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.downloadableFile)) : candid_none(),
        longDescription: value.longDescription
    };
}
...
function to_candid_record_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        tradingViewUsername: value.tradingViewUsername ? candid_some(value.tradingViewUsername) : candid_none()
    };
}
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InviteStatusType): {
    expired: null;
} | {
    pending: null;
} | {
    ...
    return value == InviteStatusType.expired ? {
        expired: null
    } : value == InviteStatusType.pending ? {
        pending: null
    } : value == InviteStatusType.granted ? {
        granted: null
    } : value == InviteStatusType.usernameIncorrect ? {
        usernameIncorrect: null
    } : value;
}
